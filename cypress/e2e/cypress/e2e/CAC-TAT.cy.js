...
describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('preenche e limpa os campos nome, sobrenome, email, telefone', () => {
    cy.get('#firstName')
      .type('Anderson')
...
//--------fazer upload---------------
  it('seleciona um arquivo da pasta fixtures', () => {
    cy.get('#file-upload')
      .selectFile('cypress/e2e/cypress/fixtures/example.json')
      .should(Input => {
...
//-----------------------------------
  it('seleciona um arquivo simulando um drag-and-drop', () => {
    cy.get('#file-upload')
      .selectFile('cypress/e2e/cypress/fixtures/example.json', {action: 'drag-drop'})
      .should(Input => {
        expect(Input[0].files[0].name).to.equal('example.json')
      })
  });
